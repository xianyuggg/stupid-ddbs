...
TIME_BEGIN = 946656000 # 2000.1.1
TIME_END = 1104508740 # 2004.12.31
INTERVAL = 15785
INTERVAL2 = 157
...
def gen_an_user (i):
    ...
    user = {}
    user["timestamp"] = str(timeBegin + INTERVAL * i)
    user["id"] = 'u'+str(i)
    user["uid"] = str(i)
    user["name"] = "user%d" % i
...
def gen_an_article (i):
    ...
    article = {}
    article["id"] = 'a'+str(i)
    article["timestamp"] = str(timeBegin + INTERVAL * i)
    article["aid"] = str(i)
...
def gen_an_read (i):
    timeBegin = TIME_BEGIN
    read = {}
    read["timestamp"] = str(timeBegin + INTERVAL2 * i)
    read["id"] = 'r'+str(i)
